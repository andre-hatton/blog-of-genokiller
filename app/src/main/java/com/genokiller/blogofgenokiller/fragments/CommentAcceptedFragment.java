 ...
 */
public class CommentAcceptedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.comment_accepted_layout, container, false);
        LinearLayout layout = (LinearLayout)v.findViewById(R.id.comment_accepted_layout);

        Url results = null;
        try {
            results = new Application_Model(Application_Model.METHOD_GET, getActivity()).execute(Url.BASE_URL + "admin/comments/accepted.json").get();
        ...
        if(json == null || json.length() == 0)
        {
            ...
            empty.setText("Aucun commentaire trouvé");
                ...
                try {
                    ...
                    checkBox.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Url res = null;
                            try {
                                res = new Application_Model(Application_Model.METHOD_PUT, getActivity()).execute(Url.BASE_URL + "admin/comments/"+id+"/updateAcceptComment", "accept", "false").get();
                            } catch (InterruptedException e) {
                                e.printStackTrace();
                            } catch (ExecutionException e) {
                                e.printStackTrace();
